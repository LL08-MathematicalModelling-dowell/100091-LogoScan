...
class Inferer:
    def __init__(self, source, webcam, webcam_addr, weights, device, yaml, img_size, half,load_data=True, conf_thres=0.4, iou_thres=0.45, max_det=1000, classes=80, agnostic_nms=False):
    ...
    def infer_image(self, image_np):
        ...
        # Resize and pad
        img, _, _ = letterbox(image_np, new_shape=self.img_size)
        ...
        detections = non_max_suppression(
            ...
            self.conf_thres,
            self.iou_thres,
            classes=None if self.classes == 80 else self.classes,
